...
def pytest_configure(config):
    ...
    config.addinivalue_line("markers", "smoke_test: Mark test as orchestrator smoke test")
    config.addinivalue_line("markers", "basic_workflow: Mark test as basic workflow test")
    config.addinivalue_line("markers", "mcp_integration: Mark test as MCP integration test")
    config.addinivalue_line("markers", "approval_workflow: Mark test as approval workflow test")
