...
class TestActivitiesIntegration:
    ...
    def test_activity_config_validation_integration(self):
        ...
        config = {"timeout_seconds": 600, "max_retries": 3}
    ...
    def test_activity_with_complex_data(self):
        ...
        complex_data = {
            "task": {"id": "task_123", "name": "Complex Task", "nested": {"level1": {"level2": "deep_value"}}},
            "metadata": {"created": datetime.utcnow().isoformat(), "tags": ["urgent", "important"]},
        }
