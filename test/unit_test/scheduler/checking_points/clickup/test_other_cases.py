...
class TestClickUpCheckingPointIntegration:
    ...
    async def test_multiple_checking_points_evaluation(self):
        ...
        data = MonitoringData(
            ...
            source="clickup",
            data={"id": "task_critical", "priority": "urgent", "due_date": "2024-01-01", "status": "open"},
        )
    ...
    async def test_checking_point_with_empty_data(self):
        ...
        data = MonitoringData(id="empty_task", type=MonitoringDataType.CLICKUP_TASK, source="clickup", data={})
