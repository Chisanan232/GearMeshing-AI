...
from gearmeshing_ai.scheduler.models.workflow import AIAction, AIActionType, AIWorkflowResult
...
class TestAIWorkflowActivity:
    ...
    async def test_execute_workflow_with_approval(self):
        ...
        data = MonitoringData(
            id="task_2", type=MonitoringDataType.CLICKUP_TASK, source="clickup", data={"id": "task_2"}
        )
    ...
    async def test_execute_workflow_failure(self):
        ...
        data = MonitoringData(
            id="task_3", type=MonitoringDataType.CLICKUP_TASK, source="clickup", data={"id": "task_3"}
        )
    ...
    async def test_execute_workflow_with_retry(self):
        ...
        data = MonitoringData(
            id="task_4", type=MonitoringDataType.CLICKUP_TASK, source="clickup", data={"id": "task_4"}
        )
    ...
    async def test_execute_workflow_with_timeout(self):
        ...
        data = MonitoringData(
            id="task_5", type=MonitoringDataType.CLICKUP_TASK, source="clickup", data={"id": "task_5"}
        )
    ...
    async def test_execute_multiple_actions(self):
        ...
        data = MonitoringData(
            id="task_6", type=MonitoringDataType.CLICKUP_TASK, source="clickup", data={"id": "task_6"}
        )
    ...
    async def test_workflow_with_prompt_template(self):
        ...
        data = MonitoringData(
            id="task_7", type=MonitoringDataType.CLICKUP_TASK, source="clickup", data={"id": "task_7"}
        )
    ...
    async def test_workflow_with_agent_role(self):
        ...
        data = MonitoringData(
            id="task_8", type=MonitoringDataType.CLICKUP_TASK, source="clickup", data={"id": "task_8"}
        )
    ...
    async def test_workflow_execution_duration(self):
        ...
        data = MonitoringData(
            id="task_9", type=MonitoringDataType.CLICKUP_TASK, source="clickup", data={"id": "task_9"}
        )
    ...
    async def test_workflow_with_escalation_action(self):
        ...
        data = MonitoringData(
            id="task_10", type=MonitoringDataType.CLICKUP_TASK, source="clickup", data={"id": "task_10"}
        )
