...
class TestCreateGlobalResponse:
    ...
    def test_create_global_response_success(self):
        ...
        content = {"data": "test"}
        response = create_global_response(
            success=True,
    ...
    def test_create_global_response_different_content_types(self):
        ...
        # String content
        response1 = create_global_response(
            success=True,
        ...
        # Dict content
        response2 = create_global_response(
            success=True,
        ...
        # List content
        response3 = create_global_response(
            success=True,
...
class TestUtilityIntegration:
    ...
    def test_utility_functions_with_real_data(self):
        ...
        api_info = create_api_info_response(
            ...
            endpoints=[
                "/health", "/info", "/users", "/orders", "/products"
            ],
            documentation={
