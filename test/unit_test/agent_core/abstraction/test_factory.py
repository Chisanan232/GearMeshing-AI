...
class TestAgentFactory:
    ...
    def test_register_overwrite_behavior(self):
        ...
        agent_settings1 = AgentSettings(
            ...
            model_settings=model_settings1
        )
        ...
        model_settings2 = ModelSettings(
            customized_name="test-model-2",
            provider="anthropic",
            model="claude-3"
        )
    ...
    def test_factory_registry_size_limits(self):
        ...
        for i in range(100):
            model_settings = ModelSettings(
                customized_name=f"custom-model-{i}",
                provider="anthropic",
                model="claude-3"
            )
            factory.register_model_settings(model_settings)
