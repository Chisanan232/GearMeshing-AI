...
- test_cache.py: Tests for AgentCache singleton implementation
- test_factory.py: Tests for AgentFactory
- test_env_manager.py: Tests for EnvManager
- test_mcp.py: Tests for MCPClientAbstraction abstract base class

All tests cover normal usage scenarios, edge cases, and error handling.
"""
