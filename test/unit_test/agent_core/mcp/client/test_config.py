...
class TestRetryConfig:
    ...
    def test_retry_config_custom_values(self):
        ...
        config = RetryConfig(max_retries=5, base_delay=2.0, max_delay=60.0, backoff_factor=3.0, jitter=False)
...
class TestTransportConfig:
    ...
    def test_transport_config_custom_values(self):
        ...
        config = TransportConfig(connection_timeout=45.0, read_timeout=90.0, write_timeout=90.0)
...
class TestMCPClientConfig:
    ...
    def test_mcp_client_config_custom_values(self):
        ...
        config = MCPClientConfig(timeout=60.0, max_concurrent_requests=20, retry_policy=retry_config)
    ...
    def test_mcp_client_config_from_dict(self):
        ...
        config_dict = {
            ...
            "retry_policy": {"max_retries": 4, "base_delay": 1.5},
        }
    ...
    def test_mcp_client_config_from_env(self):
        ...
        with patch.dict("os.environ", {"MCP_CLIENT_TIMEOUT": "60", "MCP_CLIENT_MAX_CONCURRENT_REQUESTS": "20"}):
    ...
    def test_mcp_client_config_from_file(self):
        ...
        config_dict = {"timeout": 50.0, "max_concurrent_requests": 25}
