...
class TestConnectionError:
    ...
    def test_connection_error_creation(self):
        ...
        assert str(error) == "Connection failed | operation: list_tools | server: http://localhost:8082/sse/sse | retries: 1"
        assert error.operation == "list_tools"
        assert error.server_url == "http://localhost:8082/sse/sse"
    ...
    def test_connection_error_str_representation(self):
        ...
        error_str = str(error)
        assert error_str == "Connection failed | operation: list_tools | server: http://localhost:8082/sse/sse | retries: 1"
