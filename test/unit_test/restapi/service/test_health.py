...
class TestHealthCheckerProtocol:
    ...
    def test_health_checker_protocol_compliance(self) -> None:
        ...
        mock_checker.check_health.return_value = HealthStatusContent(status="healthy", details={"test": "ok"})
    ...
    def test_health_checker_protocol_with_real_class(self) -> None:
        ...
        class TestHealthChecker:
            def check_health(self) -> HealthStatusContent:
                return HealthStatusContent(status="healthy", details={"test": "ok"})
...
class TestBaseHealthChecker:
    ...
    def test_base_health_checker_success(self) -> None:
        ...
        class SuccessHealthChecker(BaseHealthChecker):
            ...
            def _do_check_health(self) -> HealthStatusContent:
                return HealthStatusContent(status="healthy", details={"test": "success"})
...
class TestHealthCheckService:
    ...
    def test_check_all_health_all_healthy(self) -> None:
        ...
        checker1 = MagicMock(spec=HealthChecker)
        checker1.name = "checker1"
        checker1.check_health.return_value = HealthStatusContent(status="healthy", details={"test": "ok1"})

        checker2 = MagicMock(spec=HealthChecker)
        checker2.name = "checker2"
        checker2.check_health.return_value = HealthStatusContent(status="healthy", details={"test": "ok2"})
    ...
    def test_check_all_health_one_unhealthy(self) -> None:
        ...
        checker2 = MagicMock(spec=HealthChecker)
        checker2.name = "checker2"
        checker2.check_health.return_value = HealthStatusContent(status="unhealthy", details={"error": "failed"})
    ...
    def test_check_all_health_one_degraded(self) -> None:
        ...
        checker2 = MagicMock(spec=HealthChecker)
        checker2.name = "checker2"
        checker2.check_health.return_value = HealthStatusContent(status="degraded", details={"warning": "slow"})
    ...
    def test_check_all_health_mixed_statuses(self) -> None:
        ...
        checker3.check_health.return_value = HealthStatusContent(status="unhealthy", details={"error": "failed"})
    ...
    def test_check_all_health_concurrent_safety(self) -> None:
        ...
        checker = MagicMock(spec=HealthChecker)
        checker.name = "test_checker"
        checker.check_health.return_value = HealthStatusContent(status="healthy", details={"test": "ok"})
        service.register_checker(checker)
    ...
    def test_health_service_performance(self) -> None:
        ...
        for i in range(10):
            ...
            checker.check_health.return_value = HealthStatusContent(
                status="healthy", details={"checker": f"checker_{i}"}
            )
            service.register_checker(checker)
    ...
    def test_health_service_with_very_slow_checker(self) -> None:
        ...
        class SlowChecker(BaseHealthChecker):
            ...
            def _do_check_health(self) -> HealthStatusContent:
                ...
                return HealthStatusContent(status="healthy", details={"slow": True})
