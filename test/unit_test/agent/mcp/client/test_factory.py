...
class TestMCPClientFactoryFromDict:
    ...
    def test_create_client_from_dict(self):
        ...
        config_dict = {"timeout": 45.0, "retry_policy": {"max_retries": 3, "base_delay": 1.0, "max_delay": 30.0}}
        factory = MCPClientFactory()
...
class TestMCPClientFactoryFromEnvironment:
    ...
    def test_create_client_from_env(self):
        ...
        with patch.dict("os.environ", {"MCP_CLIENT_TIMEOUT": "60", "MCP_CLIENT_MAX_RETRIES": "5"}):
            factory = MCPClientFactory()
...
class TestMCPClientFactoryFromFile:
    ...
    def test_create_client_from_file_json(self):
        ...
        config_dict = {"timeout": 50.0, "retry_policy": {"max_retries": 4, "base_delay": 1.5}}
...
class TestMCPClientFactoryAutoConnect:
    ...
    async def test_sse_client_auto_connect(self):
        ...
        with patch("gearmeshing_ai.agent.mcp.client.core.SSETransport") as mock_transport_class:
            ...
            client = await factory.create_sse_client("http://localhost:8082/sse/sse", auto_connect=True)
...
class TestFactoryErrorHandling:
    ...
    def test_create_transport_invalid_type(self):
        ...
        with pytest.raises(ConfigurationError):
            factory.create_transport_from_dict({"type": "invalid", "url": "http://localhost:8082/sse/sse"})
