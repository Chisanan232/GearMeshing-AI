...
from gearmeshing_ai.core.models.io import HealthStatus, LivenessStatus, ReadinessStatus, SimpleHealthStatus
        ...
        with patch("gearmeshing_ai.restapi.dependencies.health.create_default_health_service") as mock_create:
            ...
            mock_service.check_all_health.return_value = {
                ...
                "checkers": {
                    ...
                    "application": {
                        "status": "healthy",
                        "details": {"version": "1.0.0", "uptime": "2d 14h 32m", "memory_usage": "45%"},
                    },
                },
            }
            mock_create.return_value = mock_service
...
class TestSecurityAndCompliance:
    ...
    def test_request_validation_security(self) -> None:
        ...
        response = self.client.get("/", headers={"User-Agent": "A" * 10000})
