...
class TestWorkflowsE2E:
    ...
    def test_workflow_with_multiple_retry_policies(self):
        ...
        policies = {
            "fast": workflow.create_retry_policy(initial_interval=timedelta(milliseconds=100), maximum_attempts=2),
            "medium": workflow.create_retry_policy(initial_interval=timedelta(seconds=1), maximum_attempts=5),
            "slow": workflow.create_retry_policy(initial_interval=timedelta(seconds=5), maximum_attempts=10),
        }
