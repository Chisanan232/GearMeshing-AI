...
class TestActivitiesE2E:
    ...
    def test_complete_activity_execution_workflow(self):
        ...
        data = MonitoringData(
            ...
            source="clickup",
            data={"id": "task_activity_123", "name": "Process Task", "priority": "high"},
        )
    ...
    def test_activity_configuration_validation(self):
        ...
        config = {"timeout_seconds": 600, "max_retries": 3, "batch_size": 100}
        ...
        complex_data = {
            "task": {
                ...
                "metadata": {
                    ...
                    "custom_fields": {"severity": "high", "impact": "revenue", "estimated_hours": 4},
                },
                "assignees": [{"id": "user_1", "name": "John"}, {"id": "user_2", "name": "Jane"}],
            },
            "related_tasks": [
    ...
    def test_activity_batch_processing(self):
        ...
        items = [
            MonitoringData(
                id=f"task_{i}", type=MonitoringDataType.CLICKUP_TASK, source="clickup", data={"name": f"Task {i}"}
            )
            for i in range(5)
        ]
    ...
    def test_activity_validation_and_response(self):
        ...
        config = {"timeout_seconds": 300, "max_retries": 3}
