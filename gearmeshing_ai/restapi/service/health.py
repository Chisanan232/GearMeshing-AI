...
class BaseHealthChecker:
    ...
    def check_health(self) -> HealthStatusContent:
        ...
        try:
            ...
            return HealthStatusContent(
                status="unhealthy",
                details={"checker": self.name, "error": str(e)}
            )
    ...
    def _do_check_health(self) -> HealthStatusContent:
        ...
        raise NotImplementedError(
            f"{self.__class__.__name__} must implement _do_check_health"
        )
...
class DatabaseHealthChecker(BaseHealthChecker):
    ...
    def _do_check_health(self) -> HealthStatusContent:
        ...
        return HealthStatusContent(
            ...
            details={
                "checker": self.name,
                "connection_configured": self.connection_string is not None
            }
        )
    ...
    def _do_check_health(self) -> HealthStatusContent:
        ...
        return HealthStatusContent(
            ...
            details={
                "checker": self.name,
                "version": "0.0.0",
                "components": ["restapi", "agent_core", "core"]
            }
        )
    ...
    def check_all_health(self) -> Dict[str, Any]:
        ...
        for checker in self._checkers:
            try:
                ...
                results[checker_name] = HealthStatusContent(
                    status="unhealthy",
                    details={"error": str(e)}
                )
                overall_status = "unhealthy"
