...
class ScheduleManager:
    ...
    async def create_monitoring_schedule(
        ...
        try:
            ...
            raise RuntimeError(f"Failed to create monitoring schedule: {str(e)}")
    ...
    async def update_schedule(
        ...
        try:
            ...
            raise RuntimeError(f"Failed to update schedule {schedule_id}: {str(e)}")
    ...
    async def delete_schedule(self, schedule_id: str) -> None:
        ...
        try:
            ...
            raise RuntimeError(f"Failed to delete schedule {schedule_id}: {str(e)}")
    ...
    async def get_schedule_runs(
        ...
        try:
            ...
            raise RuntimeError(f"Failed to get schedule runs for {schedule_id}: {str(e)}")
    ...
    async def trigger_schedule_run(self, schedule_id: str) -> str:
        ...
        try:
            ...
            raise RuntimeError(f"Failed to trigger schedule run for {schedule_id}: {str(e)}")
    ...
    def create_weekly_cron(self, day_of_week: int = 1, hour: int = 9, minute: int = 0) -> str:
        ...
        Returns:
            Cron expression string
        """
        return self.create_cron_expression(
            minute=str(minute),
            hour=str(hour),
