...
class TemporalClient:
    ...
    async def get_workflow_result(
        ...
        try:
            ...
            raise RuntimeError(f"Failed to get workflow result: {str(e)}")
    ...
    async def cancel_workflow(self, workflow_id: str, run_id: Optional[str] = None) -> None:
        ...
        try:
            ...
            raise RuntimeError(f"Failed to cancel workflow: {str(e)}")
    ...
    async def signal_workflow(
        ...
        **kwargs: Any,
        ...
        try:
            ...
            raise RuntimeError(f"Failed to signal workflow: {str(e)}")
    ...
    async def query_workflow(
        ...
        **kwargs: Any,
        ...
        try:
            result = await self._client.query_workflow(
                workflow_id,
                query_name,
                run_id,
                *args,
            ...
            raise RuntimeError(f"Failed to query workflow: {str(e)}")
    ...
    async def get_workflow_history(
        ...
        try:
            ...
            raise RuntimeError(f"Failed to get workflow history: {str(e)}")
    ...
    async def get_task_queue_stats(self, task_queue: Optional[str] = None) -> Dict[str, Any]:
