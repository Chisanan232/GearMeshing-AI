...
class OverdueTaskCheckingPoint(ClickUpCheckingPoint):
    ...
    def __init__(self, config: Optional[Dict[str, Any]] = None):
        ...
        self.escalation_levels = self.config.get("escalation_levels", {
        ...
        self.impact_keywords = self.config.get("impact_keywords", [
            "production", "customer", "release", "deadline", "milestone",
            "critical", "blocking", "security", "compliance"
        ])
