...
from gearmeshing_ai.scheduler.checking_points.base import ClickUpCheckingPoint, CheckingPointType
...
class SmartAssignmentCheckingPoint(ClickUpCheckingPoint):
    ...
    def __init__(self, config: Optional[Dict[str, Any]] = None):
        ...
        # Team configuration
        self.team_members = self.config.get("team_members", [
            ...
            {"id": "dev_3", "name": "Full Stack Developer", "skills": ["backend", "frontend", "api"], "max_tasks": 4},
            {"id": "dev_4", "name": "DevOps Engineer", "skills": ["devops", "infrastructure", "deployment"], "max_tasks": 7},
        ])
