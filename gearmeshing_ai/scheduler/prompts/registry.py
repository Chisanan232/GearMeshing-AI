...
class PromptTemplateRegistry:
    ...
    def get_summary(self) -> Dict[str, Any]:
        ...
        return {
            ...
            "templates": {
                template_id: template.get_summary()
                for template_id, template in self._templates.items()
            },
        }
    
    def initialize(self, yaml_file_paths: Optional[List[str]] = None) -> None:
...
def initialize_prompt_registry(yaml_file_paths: Optional[List[str]] = None) -> None:
