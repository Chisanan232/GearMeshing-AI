...
async def execute_notification_action(params: dict[str, Any]) -> dict[str, Any]:
    ...
    try:
        ...
        base.logger.error(f"Error executing notification action: {e!s}")
        return {
            "success": False,
            "error": str(e),
...
async def execute_status_update_action(params: dict[str, Any]) -> dict[str, Any]:
    ...
    try:
        ...
        base.logger.error(f"Error executing status update action: {e!s}")
        return {
            "success": False,
            "error": str(e),
            "system": params.get("system", "unknown"),
...
async def execute_api_call_action(params: dict[str, Any]) -> dict[str, Any]:
    ...
    try:
        ...
        base.logger.error(f"Error executing API call action: {e!s}")
        return {
            "success": False,
            "error": str(e),
...
async def execute_webhook_action(params: dict[str, Any]) -> dict[str, Any]:
    ...
    try:
        ...
        base.logger.error(f"Error executing webhook action: {e!s}")
        return {
            "success": False,
            "error": str(e),
