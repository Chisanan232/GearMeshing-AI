...
class BaseActivity:
    ...
    def log_activity_error(self, activity_name: str, error: Exception, **context: Any) -> None:
        ...
        """
        self.logger.error(
            f"Error in activity: {activity_name}: {error!s}",
            extra={
                "activity_name": activity_name,
                "activity_id": activity.info().activity_id,
                "workflow_id": activity.info().workflow_id,
    ...
    def get_activity_info(self) -> dict[str, Any]:
        ...
        return {
            ...
            "start_to_close_timeout": info.start_to_close_timeout.total_seconds()
    ...
    def is_test_mode(self) -> bool:
        ...
        info = activity.info()
        return (hasattr(info, "test_mode") and info.test_mode) or info.activity_type.name.startswith("test_")
    ...
    def create_error_response(self, error: Exception, activity_name: str, **context: Any) -> dict[str, Any]:
    ...
    def create_success_response(self, data: Any, activity_name: str, **context: Any) -> dict[str, Any]:
