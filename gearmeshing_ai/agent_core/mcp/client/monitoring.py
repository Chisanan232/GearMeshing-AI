...
class HealthChecker:
    ...
    def __init__(self, client, config: Optional[MonitoringConfig] = None):
        """
        ...
        self._health_check_task: Optional[asyncio.Task] = None  # Alias for test compatibility
    ...
    def is_healthy(self, server_name: Optional[str] = None) -> bool:
        """
...
class PerformanceTracker:
    ...
    async def end_operation(self, operation: str) -> Optional[float]:
        """
    ...
    def get_performance_trend(self, operation: str, window_minutes: int = 5) -> Optional[str]:
        """
