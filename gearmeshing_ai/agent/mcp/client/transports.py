...
from .exceptions import ConnectionError, ServerError, TimeoutError
...
class StdioTransport(BaseTransport):
    ...
    def __init__(self, command: str, args: list[str], env: dict[str, str] | None = None, timeout: float = 30.0):
