...
from .core import AsyncMCPClient, EasyMCPClient, MCPClient
...
class MCPClientFactory:
    ...
    def __init__(self, default_config: MCPClientConfig | None = None):
    ...
    def create_client_from_file(self, file_path: str | Path) -> MCPClient:
    ...
    async def create_sse_client(
        self, url: str, config: MCPClientConfig | None = None, auto_connect: bool = False
    ) -> MCPClient:
...
class EasyMCPClientFactory:
    ...
    def create_stdio_client(
        self, command: str, args: list[str], env: dict[str, str] | None = None, timeout: float = 30.0
    ) -> EasyMCPClient:
...
class TransportFactory:
    ...
    def __init__(self, default_config: TransportConfig | None = None):
    ...
    def create_sse_transport(self, url: str, config: TransportConfig | None = None) -> SSETransport:
        """Create SSE transport.
    ...
    def create_http_transport(self, url: str, config: TransportConfig | None = None) -> HTTPTransport:
        """Create HTTP transport.
    ...
    def create_stdio_transport(
        self, command: str, args: list[str], env: dict[str, str] | None = None, config: TransportConfig | None = None
    ) -> StdioTransport:
        """Create stdio transport.
    ...
    def create_transport_from_dict(self, transport_dict: dict[str, Any]) -> BaseTransport:
        ...
        try:
            ...
            if transport_type.lower() == "stdio":
                ...
                return self.create_stdio_transport(
                    command, args, transport_dict.get("env"), transport_dict.get("config")
                )
...
def create_stdio_client(
    command: str, args: list[str], env: dict[str, str] | None = None, timeout: float = 30.0
) -> MCPClient:
